...
const DataOverview = () => {
    ...
    const slopePlotUrl = `${API_BASE_URL}/ml/trend-metrics/recent-6m-slope-plot`;
    ...
    return (
        <section className="panel">
            {/* <header className="panel__header">
                ...
                <p>
                    High-level signals extracted from the historical training
                    dataset.
                </p>
            </header> */}
            ...
            <section className="chart-card">
                <div className="chart-card__header">
                    <div>
                        <h2>Recent 6M Slope (Top Domains)</h2>
                        <p>
                            Backend-rendered chart generated from
                            trends_summary_metrics.csv.
                        </p>
                    </div>
                    <span className="pill">Plot</span>
                </div>
                <div className="chart-card__body">
                    {plotError ? (
                        <div className="alert alert--error">{plotError}</div>
                    ) : (
                        <img
                            src={slopePlotUrl}
                            alt="Top domains by recent 6 month slope"
                            className={`chart-card__image ${
                                plotLoaded ? "loaded" : "loading"
                            }`}
                            onLoad={() => setPlotLoaded(true)}
                            onError={() =>
                                setPlotError("Unable to load slope plot image.")
                            }
                        />
                    )}
                </div>
